...
from smooth_rancer import Smooth
...
if __name__ == "__main__":
    ...
    for i in tqdm(range(len(dataset))):
        ...
        rancer_matrices_folder = r"../rotation_matrices_ce_loss"
        ...
        # certify the point
        smoothed_classifier = Smooth(model, num_classes, sigma, rotation_matrix, certificate)
